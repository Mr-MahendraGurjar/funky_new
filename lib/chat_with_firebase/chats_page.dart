...
import 'group_chat/group_page.dart';
                ...
                Obx(() => controller.selectedChatList.isNotEmpty
                    ? Row(
                        children: [
                          ...
                          IconButton(
                              onPressed: () async {
                                await FirebaseServices.addToArchived(
                                    controller.selectedChatList);
            ...
            children: [
              StreamBuilder<DocumentSnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List archivedUsers = snapshot.data?.get('user_ids') ?? [];
                    return Visibility(
                      visible: archivedUsers.isNotEmpty,
                      child: Padding(
                        padding: const EdgeInsets.only(left: 20, top: 20),
                        child: InkWell(
                          onTap: () {
                            Get.to(() => ArchivedUserChatPage());
                          },
