class GetFriendSuggestionModel {
  List<Data>? data;
  bool? error;
  String? statusCode;
  String? message;

  GetFriendSuggestionModel({this.data, this.error, this.statusCode, this.message});

  GetFriendSuggestionModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
