...
//
//   const searchUserFollowing({Key? key, required this.searchUserid})
//       : super(key: key);
//
//   @override
...
//             //       }),
//             // )),
//             Obx(() => _search_screen_controller.isSuggestionLoading.value ==
//                     true
//                 ? SizedBox.shrink()
//                 : Container(
...
//                                 await _search_screen_controller
//                                     .Follow_unfollow_api(
//                                         follow_unfollow: (FollowingData[index]
//                                             .userFollowUnfollow ==
//                                             'follow'
//                                             ? "follow"
//                                             : (FollowingData[index]
...
//                                         user_social:
//                                             FollowingData[index].socialType,
//                                         context: context);
//                                 setState(() {
//                                   getAllFollowingList();
//                                 });
...
//                                           ? "Follow Back"
//                                           : "Unfollow")),
//                                       // '${FollowingData[index].userFollowUnfollow}',
//                                       style: TextStyle(
//                                           color: Colors.white,
//                                           fontFamily: 'PR',
//                                           fontSize: 14),
...
//
//     String url =
//         ('${URLConstants.base_url}${URLConstants.followingListApi}?id=${widget.searchUserid}&login_user_id=${id_user}');
