...
import 'package:funky_new/agora/agora_live_streaming.dart';
...
class CallScreen extends StatefulWidget {
  ...
  const CallScreen({super.key, required this.isReceiver, required this.callModel});
...
class _CallScreenState extends State<CallScreen> {
  ...
  void initState() {
    ...
    _callCubit.listenToCallStatus(
        callModel: widget.callModel, context: context, isReceiver: widget.isReceiver);
    if (!widget.isReceiver) {
      ...
      _callCubit.initAgoraAndJoinChannel(
          ...
          isCaller: true,
          isVideoCall: widget.callModel.isVideoCall!);
    } else {
      //Receiver
                                      ...
                                      ? Expanded(
                                          child: InkWell(
                                            onTap: () {
                                              ...
                                              _callCubit.updateCallStatusToAccept(
                                      ...
                                      child: Container(
                                        ...
                                        child: Center(
                                          child: Padding(
                                            ...
                                            child: Text(
                                              widget.isReceiver ? 'Reject' : 'Cancel',
