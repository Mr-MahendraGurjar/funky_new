class GetPurchaseMusicList {
  List<Data>? data;
  bool? error;
  String? statusCode;
  String? message;

  GetPurchaseMusicList({this.data, this.error, this.statusCode, this.message});

  GetPurchaseMusicList.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class Data {
  ...
  Data({this.id, this.musicId, this.userId, this.songName, this.artistName, this.musicFile, this.price, this.user});
