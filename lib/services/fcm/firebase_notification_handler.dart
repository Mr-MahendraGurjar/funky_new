...
//     //     context: context,
//     //     selectNotificationCallback: (String? payload) {
//     //       if (payload != null) {
...
//       var platform = NotificationDetails(android: callChannel, iOS: null);
...
//       int notificationId = Random().nextInt(1000);
//       //var ios = const IOSNotificationDetails();
//       var platform = NotificationDetails(android: normalChannel, iOS: null);
