class GalleryModelList {
  List<Data_profile_image>? data;
  bool? error;
  String? statusCode;
  String? message;

  GalleryModelList({this.data, this.error, this.statusCode, this.message});

  GalleryModelList.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data_profile_image>[];
      json['data'].forEach((v) {
        data!.add(new Data_profile_image.fromJson(v));
      });
    }
    error = json['error'];
...
class Data_profile_image {
  ...
  Data_profile_image.fromJson(Map<String, dynamic> json) {
    iD = json['ID'];
