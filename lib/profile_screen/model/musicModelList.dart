class GetMusicList {
  ...
  GetMusicList({this.data, this.error, this.statusCode, this.message});

  GetMusicList.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class Data {
  ...
  Data({this.id, this.userId, this.songName, this.artistName, this.musicFile, this.price, this.user});
