...
import 'package:funky_new/dashboard/post_story_screen.dart';
...
class CommercialVideoPost extends StatefulWidget {
  const CommercialVideoPost({Key? key}) : super(key: key);

  @override
  State<CommercialVideoPost> createState() => _CommercialVideoPostState();
}

class _CommercialVideoPostState extends State<CommercialVideoPost> {
  ...
  _fetchAssets() async {
    data_list = await PhotoManager.getAssetPathList(onlyAll: true, type: RequestType.video);
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          'Next',
                          style: TextStyle(
                              fontSize: 14, fontFamily: 'PM', fontWeight: FontWeight.w600, color: Colors.black),
                        ),
                      ),
                    ),
                  ),
                                      ...
                                      if (_selectionMode) {
                                        return GridTile(
                                            ...
                                            child: GestureDetector(
                                              child: Container(
                                                decoration:
                                                    BoxDecoration(border: Border.all(color: Colors.white, width: 0.0)),
                                                child: Stack(
                                                  children: [
                                                    Positioned.fill(
                                                      child: Image.memory(
                                              ...
                                              onTap: () async {
                                                ...
                                                if (_selectedIndexList.isEmpty) {
                                                  ...
                                                  var file_format =
                                                      file_list[0].path.substring(file_list[0].path.lastIndexOf('.'));
                                                    ...
                                                    Navigator.push(
                                                        ...
                                                        MaterialPageRoute<void>(
                                                            builder: (BuildContext context) => VideoEditor(
                                                                  file: File(file_list[0].path),
                                                                  creator: false,
                                                                )));
                                                  } else {
                                                    setState(() {
                                                      imgFile = File(file_list[0].path);
                                                ...
                                                //   }
                                                // });
                                                print("_selectedIndexList.length : ${_selectedIndexList.length}");
                                              },
                                            ));
                                      } else {
                                        return Stack(
