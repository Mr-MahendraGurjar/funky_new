...
import 'package:funky_new/dashboard/image_editor/data/image_item.dart';
import 'package:funky_new/dashboard/image_editor/data/layer.dart';
import 'package:funky_new/dashboard/image_editor/modules/all_emojies.dart';
import 'package:funky_new/dashboard/image_editor/modules/text.dart';
...
class ImageEditor extends StatelessWidget {
  ...
  final VoidCallback? clearImageData;
  ...
  /// Set custom theme properties default is dark theme withColors.white text
  ...
  List<Widget> get filterActions {
    return [
      BackButton(onPressed: () {
        ...
        // if (widget.clearImageData != null) {
        //   print('BackButton Pressed');
        //   widget.clearImageData!();
        // }
        // Get.back();
      }),
      const Spacer(),
      ...
      child: Stack(
        children: [
          ...
          Scaffold(
            ...
            body: Container(
              // color: Colors.red,
              child: const Text('ExtendedImage.memory'),
        ...
        child: Stack(children: [
          ...
          Scaffold(
            ...
            body: Container(
              ...
              width: MediaQuery.of(context).size.width,
              decoration: BoxDecoration(
                // color: currentColor == black ?Colors.white : black,
                image: DecorationImage(
