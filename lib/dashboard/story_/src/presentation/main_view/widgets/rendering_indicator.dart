...
class RenderingIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer2<ControlNotifier, RenderingNotifier>(builder: (_, controlNotifier, renderingNotifier, __) {
                  ...
                  Padding(
                    ...
                    child: Text(
                      renderingNotifier.renderState.name == 'frames'
                          ? renderingNotifier.renderState.name + ' ' + renderingNotifier.totalFrames.toString()
