...
import '../../presentation/utils/constants/render_state.dart';
import '../providers/FfmpegProvider.dart';
import '../providers/notifiers/control_provider.dart';
import '../providers/notifiers/rendering_notifier.dart';
...
class WidgetRecorderController extends ChangeNotifier {
  ...
  void _postFrameCallback(
      Duration timestamp, ControlNotifier controlNotifier, RenderingNotifier renderingNotifier) async {
  ...
  Future<Map<String, dynamic>> export(
      {required ControlNotifier controlNotifier, required RenderingNotifier renderingNotifier}) async {
    /// paths
    String dir;
    String imagePath;
...
//     var tempDirPath = tempDir.path;
    ...
    var response = await FfmpegProvider().mergeIntoVideo(path: dir, renderType: renderingNotifier.renderType);
